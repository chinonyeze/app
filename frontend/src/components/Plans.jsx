...
export function PlansGrid({ onSelect, currentPlan }) {
  return (
      ...
      {PLANS.map((p) => {
        ...
        return (
          ...
          >
            ...
            >
              {isCurrent ? "Current plan" : p.lookup ? "Choose" : "Included"}
            </Button>
          </div>
        );
      })}
...
export function UpgradeDialog({ open, onOpenChange, currentPlan }) {
